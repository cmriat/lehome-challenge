...
@PolicyRegistry.register("implicit_pi05_v3")
class ImplicitPi05V3Policy(BasePolicy):
    """Deprecated compatibility shim. Use policy_type='lerobot' for implicit checkpoints."""

    def __init__(self, policy_path: str, dataset_root: str, task_description: str, device: str = "cuda", latent_dim: int = 8, use_delta_actions: bool = False, delta_stats_path: Optional[str] = None):
        del latent_dim
