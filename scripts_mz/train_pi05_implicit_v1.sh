#!/bin/zsh
# Pi0.5 Implicit V1 Training Script for LeHome Challenge
# Usage: pixi run submit implicit_v1 scripts_mz/train_pi05_implicit_v1.sh [NUM_GPUS]

set -uo pipefail

NUM_GPUS="${1:-8}"
CONFIG_PATH="configs/train_pi05_implicit_v1.yaml"
TRAIN_SCRIPT="scripts/train_pi05_implicit_v1.py"
PROJECT_DIR="/home/jovyan/code/vla/lehome-challenge"

LOG_DIR="${PROJECT_DIR}/logs"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
LOG_FILE="${LOG_DIR}/train_pi05_implicit_v1_${TIMESTAMP}.log"
mkdir -p "$LOG_DIR"

exec > >(tee -a "$LOG_FILE") 2>&1

echo "=============================================="
echo "Pi0.5 Implicit V1 Training: LeHome Challenge"
