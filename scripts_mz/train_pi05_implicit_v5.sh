#!/bin/zsh
# Pi0.5 Implicit V5 Training Script for LeHome Challenge
# Usage: pixi run submit implicit_v5 scripts_mz/train_pi05_implicit_v5.sh [NUM_GPUS]
...
LOG_FILE="${LOG_DIR}/train_pi05_implicit_v5_${TIMESTAMP}.log"
mkdir -p "$LOG_DIR"

exec > >(tee -a "$LOG_FILE") 2>&1

echo "=============================================="
echo "Pi0.5 Implicit V5 Training: LeHome Challenge"
