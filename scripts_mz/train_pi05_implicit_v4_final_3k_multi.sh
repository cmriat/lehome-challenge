#!/bin/zsh
# Pi0.5 Implicit V4 Final_3K Multi-node Training (2×8 H20 140G)
# Usage: pixi run submit-multi implicit_v4_final_3k 2 scripts_mz/train_pi05_implicit_v4_final_3k_multi.sh [NUM_GPUS_PER_NODE]
...
CONFIG_PATH="configs/train_pi05_implicit_v4_final_3k.yaml"
TRAIN_SCRIPT="scripts/train_pi05_implicit_v4_optimized.py"
...
LOG_FILE="${LOG_DIR}/train_implicit_v4_final_3k_node${NODE_RANK}_${TIMESTAMP}.log"
mkdir -p "$LOG_DIR"

exec > >(stdbuf -oL -eL tee -a "$LOG_FILE") 2>&1

echo "=============================================="
echo "Pi0.5 Implicit V4 Final_3K Multi-node: LeHome Challenge"
