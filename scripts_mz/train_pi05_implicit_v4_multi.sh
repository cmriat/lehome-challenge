#!/bin/zsh
# Pi0.5 Implicit V4 Multi-node Training Script for LeHome Challenge
# Usage: pixi run submit-multi implicit_v4 2 scripts_mz/train_pi05_implicit_v4_multi.sh [NUM_GPUS_PER_NODE]
...
LOG_FILE="${LOG_DIR}/train_pi05_implicit_v4_multi_node${NODE_RANK}_${TIMESTAMP}.log"
mkdir -p "$LOG_DIR"

exec > >(stdbuf -oL -eL tee -a "$LOG_FILE") 2>&1

echo "=============================================="
echo "Pi0.5 Implicit V4 Multi-node Training: LeHome Challenge"
